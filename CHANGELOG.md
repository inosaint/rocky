...
- **Mind mode** (`/rocky-mind`) — Engineer-first problem-solving: build-before-theorize, blunt corrections, explicit "Settled." closure
- **Full toggle** (`/rocky`) — activates both modes with confirmation
